import type { Bucket } from '@2min.today/lib/config/buckets.constants';
import { BUCKET_ORDER, DIGEST_DISPLAY_BUCKETS } from '@2min.today/lib/config/buckets.constants';
