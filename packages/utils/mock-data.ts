...
export const mockData: Category[] = [
    ...
    news: [
      {
        ...
        credits: [
          {
            source: "AP",
            url: "https://apnews.com/article/powell-resigns-fed-chair",
          },
          {
            source: "WSJ",
            url: "https://wsj.com/economy/central-banking/powell-resignation",
          },
        ],
        isBreaking: false,
        isLive: true,
      ...
      {
        title:
          "Federal Reserve Signals Extended Pause on Rate Cuts Through Mid-Year",
        content:
        ...
        credits: [
          {
            source: "WSJ",
            url: "https://wsj.com/economy/central-banking/fed-rate-cut-pause",
          },
          {
            source: "Bloomberg",
            url: "https://bloomberg.com/news/articles/fed-powell-rate-pause",
          },
          {
            source: "Reuters",
            url: "https://reuters.com/business/finance/fed-signals-rate-cut-pause",
          },
        ],
        isBreaking: true,
        region: "usa",
      ...
      {
        title:
          "SpaceX Starship Completes First Full Orbital Mission, Catches Both Stages",
        content:
        ...
        credits: [
          {
            source: "TechCrunch",
            url: "https://techcrunch.com/2026/spacex-starship-orbital-mission",
          },
          {
            source: "Reuters",
            url: "https://reuters.com/science/spacex-starship-full-orbital-success",
          },
        ],
        isBreaking: false,
        region: "usa",
  ...
  },
  {
    ...
    news: [
      {
        title:
          "Ukraine and Russia Hold First Direct Ceasefire Talks in Three Years",
        content:
        ...
        credits: [
          {
            source: "Reuters",
            url: "https://reuters.com/world/europe/ukraine-russia-ceasefire-talks-istanbul-2026",
          },
          {
            source: "AP",
            url: "https://apnews.com/article/ukraine-russia-ceasefire-istanbul",
          },
          {
            source: "Bloomberg",
            url: "https://bloomberg.com/news/articles/ukraine-russia-talks",
          },
        ],
        isBreaking: true,
        region: "europe",
      ...
      {
        title:
          "EU Calls Emergency Summit on Migration After 400 Drown Off Libya",
        content:
        ...
        credits: [
          {
            source: "AP",
            url: "https://apnews.com/article/eu-migration-summit-libya-drownings",
          },
          {
            source: "Reuters",
            url: "https://reuters.com/world/europe/eu-emergency-migration-summit",
          },
        ],
        isBreaking: false,
        region: "europe",
      },
      {
        ...
        credits: [
          ...
          {
            source: "AP",
            url: "https://apnews.com/article/eu-ai-act-high-risk-enforcement",
          },
        ],
        isBreaking: false,
        region: "europe",
  ...
  },
  {
    ...
    news: [
      {
        title:
          "OPEC+ Votes to Raise Output by 400,000 Barrels Per Day Starting April",
        content:
        ...
        credits: [
          {
            source: "Reuters",
            url: "https://reuters.com/business/energy/opec-output-increase-april",
          },
          {
            source: "Bloomberg",
            url: "https://bloomberg.com/energy/opec-production-hike",
          },
        ],
        isBreaking: false,
        region: "middle-east",
      ...
      {
        title:
          "Global Container Shipping Rates Drop 38% as Red Sea Rerouting Fades",
        content:
        ...
        credits: [
          {
            source: "Bloomberg",
            url: "https://bloomberg.com/news/articles/shipping-rates-drop-red-sea",
          },
          {
            source: "Reuters",
            url: "https://reuters.com/business/shipping-rates-suez-return",
          },
        ],
        isBreaking: false,
        region: "middle-east",
  ...
  {
    name: "americas",
    summary: ["India–Pakistan border tensions escalate after airstrike"],
    news: [
      {
        title:
          "India Recalls Ambassador After Cross-Border Strike Kills 12 in Pakistani Kashmir",
        content:
        ...
        credits: [
          {
            source: "AP",
            url: "https://apnews.com/article/india-pakistan-kashmir-airstrike",
          },
          {
            source: "Reuters",
            url: "https://reuters.com/world/india/india-recalls-ambassador-pakistan",
          },
        ],
        isBreaking: false,
        region: "world",
    ...
    news: [
      {
        ...
        credits: [
          {
            source: "Reuters",
            url: "https://reuters.com/world/asia-pacific/earthquake-japan-2026",
          },
          {
            source: "AP",
            url: "https://apnews.com/article/japan-earthquake-kyushu-2026",
          },
        ],
        isBreaking: false,
        isLive: true,
      ...
      {
        title:
          "China Conducts Largest Naval Drills in South China Sea Since 2016",
        content:
        ...
        credits: [
          {
            source: "Reuters",
            url: "https://reuters.com/world/china/pla-navy-south-china-sea-drills-2026",
          },
          {
            source: "AP",
            url: "https://apnews.com/article/china-south-china-sea-naval-drills",
          },
        ],
        isBreaking: false,
        region: "world",
      ...
      {
        title:
          "UN Security Council Votes to Deploy Peacekeepers to Sudan After Genocide Finding",
        content:
        ...
        credits: [
          {
            source: "Reuters",
            url: "https://reuters.com/world/africa/un-security-council-sudan-peacekeepers",
          },
          {
            source: "AP",
            url: "https://apnews.com/article/un-sudan-darfur-genocide-peacekeepers",
          },
        ],
        isBreaking: false,
        region: "world",
  ...
  },
  {
    ...
    news: [
      {
        title:
          "NVIDIA Becomes First Chipmaker to Surpass $4 Trillion in Market Capitalization",
        content:
        ...
        credits: [
          {
            source: "Bloomberg",
            url: "https://bloomberg.com/news/articles/nvidia-4-trillion-market-cap",
          },
          {
            source: "Reuters",
            url: "https://reuters.com/technology/nvidia-crosses-4-trillion",
          },
        ],
        isBreaking: false,
        region: "usa",
      ...
      {
        title:
          "Amazon Acquires Deliverr for $2.1 Billion to Expand Same-Day Logistics Network",
        content:
        ...
        credits: [
          {
            source: "AP",
            url: "https://apnews.com/article/amazon-deliverr-acquisition",
          },
          {
            source: "Bloomberg",
            url: "https://bloomberg.com/news/articles/amazon-deliverr-deal",
          },
        ],
        isBreaking: false,
        region: "usa",
  ...
  },
  {
    ...
    news: [
      {
        title:
          "OpenAI Releases GPT-5 With Native Reasoning and 1M Token Context Window",
        content:
        ...
        credits: [
          {
            source: "TechCrunch",
            url: "https://techcrunch.com/2026/openai-gpt5-launch",
          },
          {
            source: "Bloomberg",
            url: "https://bloomberg.com/news/articles/openai-gpt5-release",
          },
        ],
        isBreaking: true,
        region: "usa",
      ...
      {
        title:
          "Apple Confirms Foldable iPhone Entering Mass Production, Q4 Launch Expected",
        content:
        ...
        credits: [
          {
            source: "TechCrunch",
            url: "https://techcrunch.com/2026/apple-foldable-iphone-production",
          },
          {
            source: "Bloomberg",
            url: "https://bloomberg.com/news/articles/apple-foldable-iphone-clover",
          },
        ],
        isBreaking: false,
        region: "world",
      ...
      {
        title:
          "State-Linked Hackers Breach SWIFT Network at Six Central Banks, $340M Stolen",
        content:
        ...
        credits: [
          {
            source: "AP",
            url: "https://apnews.com/article/swift-hack-lazarus-central-banks",
          },
          {
            source: "Reuters",
            url: "https://reuters.com/technology/swift-breach-340-million-stolen",
          },
        ],
        isBreaking: false,
        region: "world",
  ...
  },
  {
    ...
    news: [
      {
        title:
          "Antarctic Ice Sheet Losing Mass 40% Faster Than Models Predicted",
        content:
        ...
        credits: [
          {
            source: "Science",
            url: "https://science.org/doi/antarctic-ice-loss-2026",
          },
          {
            source: "NASA",
            url: "https://nasa.gov/science/icesat2-antarctic-findings",
          },
        ],
        isBreaking: false,
        region: "world",
      ...
      {
        title:
          "Perseverance Rover Confirms Organic Molecules in Jezero Crater Rock Cores",
        content:
        ...
        credits: [
          {
            source: "NASA",
            url: "https://nasa.gov/perseverance/jezero-organics-confirmed",
          },
          {
            source: "Science",
            url: "https://science.org/doi/mars-organic-molecules-jezero",
          },
        ],
        isBreaking: false,
        region: "usa",
      ...
      {
        title:
          "Fermilab Muon Experiment Crosses 5-Sigma Threshold, Hinting at Fifth Fundamental Force",
        content:
        ...
        credits: [
          {
            source: "CERN",
            url: "https://home.cern/news/muon-g2-fifth-force-discovery",
          },
          {
            source: "Nature",
            url: "https://nature.com/articles/muon-anomaly-fifth-force",
          },
        ],
        isBreaking: true,
        region: "world",
  ...
  },
  {
    ...
    news: [
      {
        title:
          "WHO Declares New mpox Variant Clade Ib a Public Health Emergency of International Concern",
        content:
        ...
        credits: [
          {
            source: "WHO",
            url: "https://who.int/news/mpox-clade-ib-pheic-2026",
          },
          {
            source: "Reuters",
            url: "https://reuters.com/science/who-mpox-clade-ib-emergency",
          },
        ],
        isBreaking: true,
        region: "world",
      ...
      {
        title:
          "Meta-Study Links Ultra-Processed Food Consumption to 32 Distinct Health Conditions",
        content:
        ...
        credits: [
          {
            source: "BMJ",
            url: "https://bmj.com/content/ultra-processed-food-32-conditions",
          },
          {
            source: "AP",
            url: "https://apnews.com/article/ultra-processed-food-health-risks-study",
          },
        ],
        isBreaking: false,
        region: "europe",
      ...
      {
        title:
          "Youth Anxiety Rates Have Doubled Pre-Pandemic Levels, WHO Reports Across 78 Countries",
        content:
        ...
        credits: [
          {
            source: "WHO",
            url: "https://who.int/news/youth-anxiety-report-2026",
          },
          {
            source: "AP",
            url: "https://apnews.com/article/youth-anxiety-doubled-who-report",
          },
        ],
        isBreaking: false,
        region: "world",
  ...
  },
  {
    ...
    news: [
      {
        title:
          "Champions League Draw Sets Up Real Madrid vs Manchester City Rematch",
        content:
        ...
        credits: [
          {
            source: "BBC",
            url: "https://bbc.com/sport/football/champions-league-draw-2026",
          },
          {
            source: "Reuters",
            url: "https://reuters.com/sports/champions-league-quarterfinal-draw",
          },
        ],
        isBreaking: false,
        region: "europe",
      ...
      {
        title:
          "India Wins Cricket World Cup Final Against Australia in Record Chase",
        content:
        ...
        credits: [
          {
            source: "Reuters",
            url: "https://reuters.com/sports/cricket-world-cup-final-india-australia",
          },
          {
            source: "AP",
            url: "https://apnews.com/article/cricket-world-cup-india-wins",
          },
        ],
        isBreaking: true,
        region: "world",
      ...
      {
        title:
          "IOC Shortlists Saudi Arabia for 2036 Summer Olympics Amid Human Rights Concerns",
        content:
        ...
        credits: [
          {
            source: "AP",
            url: "https://apnews.com/article/ioc-saudi-arabia-2036-olympics",
          },
          {
            source: "Reuters",
            url: "https://reuters.com/sports/olympics-saudi-arabia-2036-bid",
          },
        ],
        isBreaking: false,
        region: "middle-east",
