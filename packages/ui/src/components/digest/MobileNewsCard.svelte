...
<div
  class="w-full shrink-0 snap-start snap-always border-b border-black/10 px-4 py-4"
  role="presentation"
>
  <div>
    <h2 class="mb-3 text-lg font-bold leading-snug tracking-tight text-black">{title}</h2>
    <ul class="space-y-2">
