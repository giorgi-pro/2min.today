<script lang="ts">
  ...
  const { title, bullets, whyItMatters, credits, tags }: NewsItem = $props();
...
<div
  class="news-tile relative flex h-full min-w-[min(100%,280px)] shrink-0 flex-col border-r border-black/10 py-2 px-2 pb-[4px]"
  onmouseleave={onCardMouseLeave}
  role="presentation"
>
  <div class="contents px-4">
    <h2 class="mb-3 mx-1 flex-none text-lg font-bold leading-snug tracking-tight text-black">{title}</h2>
