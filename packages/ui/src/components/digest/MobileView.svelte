<script lang="ts">
  import { type CategoryEntry, type Topic, TOPIC_LABELS } from '@2min.today/types';
...
<div class="flex flex-col">
  {#each categories as { bucket, index, summary, news } (bucket)}
    <div class="border-b-2 border-black">
      ...
      >
        <span class="m-6 text-xl font-black uppercase leading-none tracking-tight">{TOPIC_LABELS[bucket as Topic] ?? bucket}</span>
